...
description: This skill should be used when analyzing daily/weekly price charts for stocks, stock indices, cryptocurrencies, or forex pairs. Use this skill when the user provides chart images or if not provided use the tradingview mcp tool to fetch the chart data and then analyze it. The user will request technical analysis, trend identification, support/resistance levels, scenario planning, or probability assessments based purely on chart data without consideration of news or fundamental factors.
---
